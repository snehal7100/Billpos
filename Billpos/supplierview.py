...
def SuppliersList(request):
    ...
    return render(request, "Suppliers/Supplierindex.html", {"supplierData": sData})
...
def AddSupplier(request):
    ...
    return render(request, "Suppliers/addform.html")
...
def editSupplier(request, id):
    ...
    if request.method == "GET":
        ...
        return render(request, "Suppliers/Supplieredit.html", context)
    else:
